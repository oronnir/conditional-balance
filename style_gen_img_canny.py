...
if __name__ == "__main__":
    ...
    parser.add_argument("--canny_lower_t", type=int, default=EXTRA_STRONG_CANNY_PARAMS[0])
    parser.add_argument("--canny_upper_t", type=int, default=EXTRA_STRONG_CANNY_PARAMS[1])
